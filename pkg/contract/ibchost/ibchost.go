...
// AuthenticateCapability is a paid mutator transaction binding the contract method 0x2d46858f.
//
// Solidity: function authenticateCapability(bytes name, address addr) returns(bool)
func (_Ibchost *IbchostTransactor) AuthenticateCapability(opts *bind.TransactOpts, name []byte, addr common.Address) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "authenticateCapability", name, addr)
}

// AuthenticateCapability is a paid mutator transaction binding the contract method 0x2d46858f.
//
// Solidity: function authenticateCapability(bytes name, address addr) returns(bool)
func (_Ibchost *IbchostSession) AuthenticateCapability(name []byte, addr common.Address) (*types.Transaction, error) {
	return _Ibchost.Contract.AuthenticateCapability(&_Ibchost.TransactOpts, name, addr)
}

// AuthenticateCapability is a paid mutator transaction binding the contract method 0x2d46858f.
//
// Solidity: function authenticateCapability(bytes name, address addr) returns(bool)
func (_Ibchost *IbchostTransactorSession) AuthenticateCapability(name []byte, addr common.Address) (*types.Transaction, error) {
	return _Ibchost.Contract.AuthenticateCapability(&_Ibchost.TransactOpts, name, addr)
}
...
// GetChannel is a paid mutator transaction binding the contract method 0x3000217a.
//
// Solidity: function getChannel(string portId, string channelId) returns(ChannelData channel, bool)
func (_Ibchost *IbchostTransactor) GetChannel(opts *bind.TransactOpts, portId string, channelId string) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "getChannel", portId, channelId)
}

// GetChannel is a paid mutator transaction binding the contract method 0x3000217a.
//
// Solidity: function getChannel(string portId, string channelId) returns(ChannelData channel, bool)
func (_Ibchost *IbchostSession) GetChannel(portId string, channelId string) (*types.Transaction, error) {
	return _Ibchost.Contract.GetChannel(&_Ibchost.TransactOpts, portId, channelId)
}

// GetChannel is a paid mutator transaction binding the contract method 0x3000217a.
//
// Solidity: function getChannel(string portId, string channelId) returns(ChannelData channel, bool)
func (_Ibchost *IbchostTransactorSession) GetChannel(portId string, channelId string) (*types.Transaction, error) {
	return _Ibchost.Contract.GetChannel(&_Ibchost.TransactOpts, portId, channelId)
}

// GetClientImpl is a paid mutator transaction binding the contract method 0xbfe7aa66.
//
// Solidity: function getClientImpl(string clientType) returns(address, bool)
func (_Ibchost *IbchostTransactor) GetClientImpl(opts *bind.TransactOpts, clientType string) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "getClientImpl", clientType)
}

// GetClientImpl is a paid mutator transaction binding the contract method 0xbfe7aa66.
//
// Solidity: function getClientImpl(string clientType) returns(address, bool)
func (_Ibchost *IbchostSession) GetClientImpl(clientType string) (*types.Transaction, error) {
	return _Ibchost.Contract.GetClientImpl(&_Ibchost.TransactOpts, clientType)
}

// GetClientImpl is a paid mutator transaction binding the contract method 0xbfe7aa66.
//
// Solidity: function getClientImpl(string clientType) returns(address, bool)
func (_Ibchost *IbchostTransactorSession) GetClientImpl(clientType string) (*types.Transaction, error) {
	return _Ibchost.Contract.GetClientImpl(&_Ibchost.TransactOpts, clientType)
}

// GetClientState is a paid mutator transaction binding the contract method 0x76c81c42.
//
// Solidity: function getClientState(string clientId) returns(bytes, bool)
func (_Ibchost *IbchostTransactor) GetClientState(opts *bind.TransactOpts, clientId string) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "getClientState", clientId)
}

// GetClientState is a paid mutator transaction binding the contract method 0x76c81c42.
//
// Solidity: function getClientState(string clientId) returns(bytes, bool)
func (_Ibchost *IbchostSession) GetClientState(clientId string) (*types.Transaction, error) {
	return _Ibchost.Contract.GetClientState(&_Ibchost.TransactOpts, clientId)
}

// GetClientState is a paid mutator transaction binding the contract method 0x76c81c42.
//
// Solidity: function getClientState(string clientId) returns(bytes, bool)
func (_Ibchost *IbchostTransactorSession) GetClientState(clientId string) (*types.Transaction, error) {
	return _Ibchost.Contract.GetClientState(&_Ibchost.TransactOpts, clientId)
}

// GetClientType is a paid mutator transaction binding the contract method 0x84515f5d.
//
// Solidity: function getClientType(string clientId) returns(string)
func (_Ibchost *IbchostTransactor) GetClientType(opts *bind.TransactOpts, clientId string) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "getClientType", clientId)
}

// GetClientType is a paid mutator transaction binding the contract method 0x84515f5d.
//
// Solidity: function getClientType(string clientId) returns(string)
func (_Ibchost *IbchostSession) GetClientType(clientId string) (*types.Transaction, error) {
	return _Ibchost.Contract.GetClientType(&_Ibchost.TransactOpts, clientId)
}

// GetClientType is a paid mutator transaction binding the contract method 0x84515f5d.
//
// Solidity: function getClientType(string clientId) returns(string)
func (_Ibchost *IbchostTransactorSession) GetClientType(clientId string) (*types.Transaction, error) {
	return _Ibchost.Contract.GetClientType(&_Ibchost.TransactOpts, clientId)
}

// GetConnection is a paid mutator transaction binding the contract method 0x27711a69.
//
// Solidity: function getConnection(string connectionId) returns(ConnectionEndData connection, bool)
func (_Ibchost *IbchostTransactor) GetConnection(opts *bind.TransactOpts, connectionId string) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "getConnection", connectionId)
}

// GetConnection is a paid mutator transaction binding the contract method 0x27711a69.
//
// Solidity: function getConnection(string connectionId) returns(ConnectionEndData connection, bool)
func (_Ibchost *IbchostSession) GetConnection(connectionId string) (*types.Transaction, error) {
	return _Ibchost.Contract.GetConnection(&_Ibchost.TransactOpts, connectionId)
}

// GetConnection is a paid mutator transaction binding the contract method 0x27711a69.
//
// Solidity: function getConnection(string connectionId) returns(ConnectionEndData connection, bool)
func (_Ibchost *IbchostTransactorSession) GetConnection(connectionId string) (*types.Transaction, error) {
	return _Ibchost.Contract.GetConnection(&_Ibchost.TransactOpts, connectionId)
}

// GetConsensusState is a paid mutator transaction binding the contract method 0x6cf44bf4.
//
// Solidity: function getConsensusState(string clientId, HeightData height) returns(bytes, bool)
func (_Ibchost *IbchostTransactor) GetConsensusState(opts *bind.TransactOpts, clientId string, height HeightData) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "getConsensusState", clientId, height)
}

// GetConsensusState is a paid mutator transaction binding the contract method 0x6cf44bf4.
//
// Solidity: function getConsensusState(string clientId, HeightData height) returns(bytes, bool)
func (_Ibchost *IbchostSession) GetConsensusState(clientId string, height HeightData) (*types.Transaction, error) {
	return _Ibchost.Contract.GetConsensusState(&_Ibchost.TransactOpts, clientId, height)
}

// GetConsensusState is a paid mutator transaction binding the contract method 0x6cf44bf4.
//
// Solidity: function getConsensusState(string clientId, HeightData height) returns(bytes, bool)
func (_Ibchost *IbchostTransactorSession) GetConsensusState(clientId string, height HeightData) (*types.Transaction, error) {
	return _Ibchost.Contract.GetConsensusState(&_Ibchost.TransactOpts, clientId, height)
}

// GetExpectedTimePerBlock is a paid mutator transaction binding the contract method 0xec75d829.
//
// Solidity: function getExpectedTimePerBlock() returns(uint64)
func (_Ibchost *IbchostTransactor) GetExpectedTimePerBlock(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "getExpectedTimePerBlock")
}

// GetExpectedTimePerBlock is a paid mutator transaction binding the contract method 0xec75d829.
//
// Solidity: function getExpectedTimePerBlock() returns(uint64)
func (_Ibchost *IbchostSession) GetExpectedTimePerBlock() (*types.Transaction, error) {
	return _Ibchost.Contract.GetExpectedTimePerBlock(&_Ibchost.TransactOpts)
}

// GetExpectedTimePerBlock is a paid mutator transaction binding the contract method 0xec75d829.
//
// Solidity: function getExpectedTimePerBlock() returns(uint64)
func (_Ibchost *IbchostTransactorSession) GetExpectedTimePerBlock() (*types.Transaction, error) {
	return _Ibchost.Contract.GetExpectedTimePerBlock(&_Ibchost.TransactOpts)
}

// GetModuleOwner is a paid mutator transaction binding the contract method 0xace6cfb7.
//
// Solidity: function getModuleOwner(bytes name) returns(address, bool)
func (_Ibchost *IbchostTransactor) GetModuleOwner(opts *bind.TransactOpts, name []byte) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "getModuleOwner", name)
}

// GetModuleOwner is a paid mutator transaction binding the contract method 0xace6cfb7.
//
// Solidity: function getModuleOwner(bytes name) returns(address, bool)
func (_Ibchost *IbchostSession) GetModuleOwner(name []byte) (*types.Transaction, error) {
	return _Ibchost.Contract.GetModuleOwner(&_Ibchost.TransactOpts, name)
}

// GetModuleOwner is a paid mutator transaction binding the contract method 0xace6cfb7.
//
// Solidity: function getModuleOwner(bytes name) returns(address, bool)
func (_Ibchost *IbchostTransactorSession) GetModuleOwner(name []byte) (*types.Transaction, error) {
	return _Ibchost.Contract.GetModuleOwner(&_Ibchost.TransactOpts, name)
}

// GetNextSequenceAck is a paid mutator transaction binding the contract method 0x4e08c6f3.
//
// Solidity: function getNextSequenceAck(string portId, string channelId) returns(uint64)
func (_Ibchost *IbchostTransactor) GetNextSequenceAck(opts *bind.TransactOpts, portId string, channelId string) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "getNextSequenceAck", portId, channelId)
}

// GetNextSequenceAck is a paid mutator transaction binding the contract method 0x4e08c6f3.
//
// Solidity: function getNextSequenceAck(string portId, string channelId) returns(uint64)
func (_Ibchost *IbchostSession) GetNextSequenceAck(portId string, channelId string) (*types.Transaction, error) {
	return _Ibchost.Contract.GetNextSequenceAck(&_Ibchost.TransactOpts, portId, channelId)
}

// GetNextSequenceAck is a paid mutator transaction binding the contract method 0x4e08c6f3.
//
// Solidity: function getNextSequenceAck(string portId, string channelId) returns(uint64)
func (_Ibchost *IbchostTransactorSession) GetNextSequenceAck(portId string, channelId string) (*types.Transaction, error) {
	return _Ibchost.Contract.GetNextSequenceAck(&_Ibchost.TransactOpts, portId, channelId)
}

// GetNextSequenceRecv is a paid mutator transaction binding the contract method 0xe211bb06.
//
// Solidity: function getNextSequenceRecv(string portId, string channelId) returns(uint64)
func (_Ibchost *IbchostTransactor) GetNextSequenceRecv(opts *bind.TransactOpts, portId string, channelId string) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "getNextSequenceRecv", portId, channelId)
}

// GetNextSequenceRecv is a paid mutator transaction binding the contract method 0xe211bb06.
//
// Solidity: function getNextSequenceRecv(string portId, string channelId) returns(uint64)
func (_Ibchost *IbchostSession) GetNextSequenceRecv(portId string, channelId string) (*types.Transaction, error) {
	return _Ibchost.Contract.GetNextSequenceRecv(&_Ibchost.TransactOpts, portId, channelId)
}

// GetNextSequenceRecv is a paid mutator transaction binding the contract method 0xe211bb06.
//
// Solidity: function getNextSequenceRecv(string portId, string channelId) returns(uint64)
func (_Ibchost *IbchostTransactorSession) GetNextSequenceRecv(portId string, channelId string) (*types.Transaction, error) {
	return _Ibchost.Contract.GetNextSequenceRecv(&_Ibchost.TransactOpts, portId, channelId)
}

// GetNextSequenceSend is a paid mutator transaction binding the contract method 0x582418b6.
//
// Solidity: function getNextSequenceSend(string portId, string channelId) returns(uint64)
func (_Ibchost *IbchostTransactor) GetNextSequenceSend(opts *bind.TransactOpts, portId string, channelId string) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "getNextSequenceSend", portId, channelId)
}

// GetNextSequenceSend is a paid mutator transaction binding the contract method 0x582418b6.
//
// Solidity: function getNextSequenceSend(string portId, string channelId) returns(uint64)
func (_Ibchost *IbchostSession) GetNextSequenceSend(portId string, channelId string) (*types.Transaction, error) {
	return _Ibchost.Contract.GetNextSequenceSend(&_Ibchost.TransactOpts, portId, channelId)
}

// GetNextSequenceSend is a paid mutator transaction binding the contract method 0x582418b6.
//
// Solidity: function getNextSequenceSend(string portId, string channelId) returns(uint64)
func (_Ibchost *IbchostTransactorSession) GetNextSequenceSend(portId string, channelId string) (*types.Transaction, error) {
	return _Ibchost.Contract.GetNextSequenceSend(&_Ibchost.TransactOpts, portId, channelId)
}

// GetPacketAcknowledgementCommitment is a paid mutator transaction binding the contract method 0x71f56c59.
//
// Solidity: function getPacketAcknowledgementCommitment(string portId, string channelId, uint64 sequence) returns(bytes32, bool)
func (_Ibchost *IbchostTransactor) GetPacketAcknowledgementCommitment(opts *bind.TransactOpts, portId string, channelId string, sequence uint64) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "getPacketAcknowledgementCommitment", portId, channelId, sequence)
}

// GetPacketAcknowledgementCommitment is a paid mutator transaction binding the contract method 0x71f56c59.
//
// Solidity: function getPacketAcknowledgementCommitment(string portId, string channelId, uint64 sequence) returns(bytes32, bool)
func (_Ibchost *IbchostSession) GetPacketAcknowledgementCommitment(portId string, channelId string, sequence uint64) (*types.Transaction, error) {
	return _Ibchost.Contract.GetPacketAcknowledgementCommitment(&_Ibchost.TransactOpts, portId, channelId, sequence)
}

// GetPacketAcknowledgementCommitment is a paid mutator transaction binding the contract method 0x71f56c59.
//
// Solidity: function getPacketAcknowledgementCommitment(string portId, string channelId, uint64 sequence) returns(bytes32, bool)
func (_Ibchost *IbchostTransactorSession) GetPacketAcknowledgementCommitment(portId string, channelId string, sequence uint64) (*types.Transaction, error) {
	return _Ibchost.Contract.GetPacketAcknowledgementCommitment(&_Ibchost.TransactOpts, portId, channelId, sequence)
}
...
func (_Ibchost *IbchostTransactor) GetPacketCommitment(opts *bind.TransactOpts, portId string, channelId string, sequence uint64) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "getPacketCommitment", portId, channelId, sequence)
}

// GetPacketCommitment is a paid mutator transaction binding the contract method 0x61fc5e7b.
//
// Solidity: function getPacketCommitment(string portId, string channelId, uint64 sequence) returns(bytes32, bool)
func (_Ibchost *IbchostSession) GetPacketCommitment(portId string, channelId string, sequence uint64) (*types.Transaction, error) {
	return _Ibchost.Contract.GetPacketCommitment(&_Ibchost.TransactOpts, portId, channelId, sequence)
}

// GetPacketCommitment is a paid mutator transaction binding the contract method 0x61fc5e7b.
//
// Solidity: function getPacketCommitment(string portId, string channelId, uint64 sequence) returns(bytes32, bool)
func (_Ibchost *IbchostTransactorSession) GetPacketCommitment(portId string, channelId string, sequence uint64) (*types.Transaction, error) {
	return _Ibchost.Contract.GetPacketCommitment(&_Ibchost.TransactOpts, portId, channelId, sequence)
}

// GetProcessedHeight is a paid mutator transaction binding the contract method 0x1172938a.
//
// Solidity: function getProcessedHeight(string clientId, HeightData height) returns(uint256, bool)
func (_Ibchost *IbchostTransactor) GetProcessedHeight(opts *bind.TransactOpts, clientId string, height HeightData) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "getProcessedHeight", clientId, height)
}

// GetProcessedHeight is a paid mutator transaction binding the contract method 0x1172938a.
//
// Solidity: function getProcessedHeight(string clientId, HeightData height) returns(uint256, bool)
func (_Ibchost *IbchostSession) GetProcessedHeight(clientId string, height HeightData) (*types.Transaction, error) {
	return _Ibchost.Contract.GetProcessedHeight(&_Ibchost.TransactOpts, clientId, height)
}

// GetProcessedHeight is a paid mutator transaction binding the contract method 0x1172938a.
//
// Solidity: function getProcessedHeight(string clientId, HeightData height) returns(uint256, bool)
func (_Ibchost *IbchostTransactorSession) GetProcessedHeight(clientId string, height HeightData) (*types.Transaction, error) {
	return _Ibchost.Contract.GetProcessedHeight(&_Ibchost.TransactOpts, clientId, height)
}

// GetProcessedTime is a paid mutator transaction binding the contract method 0xc040ff75.
//
// Solidity: function getProcessedTime(string clientId, HeightData height) returns(uint256, bool)
func (_Ibchost *IbchostTransactor) GetProcessedTime(opts *bind.TransactOpts, clientId string, height HeightData) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "getProcessedTime", clientId, height)
}

// GetProcessedTime is a paid mutator transaction binding the contract method 0xc040ff75.
//
// Solidity: function getProcessedTime(string clientId, HeightData height) returns(uint256, bool)
func (_Ibchost *IbchostSession) GetProcessedTime(clientId string, height HeightData) (*types.Transaction, error) {
	return _Ibchost.Contract.GetProcessedTime(&_Ibchost.TransactOpts, clientId, height)
}

// GetProcessedTime is a paid mutator transaction binding the contract method 0xc040ff75.
//
// Solidity: function getProcessedTime(string clientId, HeightData height) returns(uint256, bool)
func (_Ibchost *IbchostTransactorSession) GetProcessedTime(clientId string, height HeightData) (*types.Transaction, error) {
	return _Ibchost.Contract.GetProcessedTime(&_Ibchost.TransactOpts, clientId, height)
}

// HasPacketReceipt is a paid mutator transaction binding the contract method 0x5a9afac3.
//
// Solidity: function hasPacketReceipt(string portId, string channelId, uint64 sequence) returns(bool)
func (_Ibchost *IbchostTransactor) HasPacketReceipt(opts *bind.TransactOpts, portId string, channelId string, sequence uint64) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "hasPacketReceipt", portId, channelId, sequence)
}

// HasPacketReceipt is a paid mutator transaction binding the contract method 0x5a9afac3.
//
// Solidity: function hasPacketReceipt(string portId, string channelId, uint64 sequence) returns(bool)
func (_Ibchost *IbchostSession) HasPacketReceipt(portId string, channelId string, sequence uint64) (*types.Transaction, error) {
	return _Ibchost.Contract.HasPacketReceipt(&_Ibchost.TransactOpts, portId, channelId, sequence)
}

// HasPacketReceipt is a paid mutator transaction binding the contract method 0x5a9afac3.
//
// Solidity: function hasPacketReceipt(string portId, string channelId, uint64 sequence) returns(bool)
func (_Ibchost *IbchostTransactorSession) HasPacketReceipt(portId string, channelId string, sequence uint64) (*types.Transaction, error) {
	return _Ibchost.Contract.HasPacketReceipt(&_Ibchost.TransactOpts, portId, channelId, sequence)
}

// MakePacketAcknowledgementCommitment is a paid mutator transaction binding the contract method 0x8a889658.
//
// Solidity: function makePacketAcknowledgementCommitment(bytes acknowledgement) returns(bytes32)
func (_Ibchost *IbchostTransactor) MakePacketAcknowledgementCommitment(opts *bind.TransactOpts, acknowledgement []byte) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "makePacketAcknowledgementCommitment", acknowledgement)
}

// MakePacketAcknowledgementCommitment is a paid mutator transaction binding the contract method 0x8a889658.
//
// Solidity: function makePacketAcknowledgementCommitment(bytes acknowledgement) returns(bytes32)
func (_Ibchost *IbchostSession) MakePacketAcknowledgementCommitment(acknowledgement []byte) (*types.Transaction, error) {
	return _Ibchost.Contract.MakePacketAcknowledgementCommitment(&_Ibchost.TransactOpts, acknowledgement)
}

// MakePacketAcknowledgementCommitment is a paid mutator transaction binding the contract method 0x8a889658.
//
// Solidity: function makePacketAcknowledgementCommitment(bytes acknowledgement) returns(bytes32)
func (_Ibchost *IbchostTransactorSession) MakePacketAcknowledgementCommitment(acknowledgement []byte) (*types.Transaction, error) {
	return _Ibchost.Contract.MakePacketAcknowledgementCommitment(&_Ibchost.TransactOpts, acknowledgement)
}

// MakePacketCommitment is a paid mutator transaction binding the contract method 0x12a68750.
//
// Solidity: function makePacketCommitment(PacketData packet) returns(bytes32)
func (_Ibchost *IbchostTransactor) MakePacketCommitment(opts *bind.TransactOpts, packet PacketData) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "makePacketCommitment", packet)
}

// MakePacketCommitment is a paid mutator transaction binding the contract method 0x12a68750.
//
// Solidity: function makePacketCommitment(PacketData packet) returns(bytes32)
func (_Ibchost *IbchostSession) MakePacketCommitment(packet PacketData) (*types.Transaction, error) {
	return _Ibchost.Contract.MakePacketCommitment(&_Ibchost.TransactOpts, packet)
}

// MakePacketCommitment is a paid mutator transaction binding the contract method 0x12a68750.
//
// Solidity: function makePacketCommitment(PacketData packet) returns(bytes32)
func (_Ibchost *IbchostTransactorSession) MakePacketCommitment(packet PacketData) (*types.Transaction, error) {
	return _Ibchost.Contract.MakePacketCommitment(&_Ibchost.TransactOpts, packet)
}

// OnlyIBCModule is a paid mutator transaction binding the contract method 0x1649a4f7.
//
// Solidity: function onlyIBCModule() returns()
func (_Ibchost *IbchostTransactor) OnlyIBCModule(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Ibchost.contract.Transact(opts, "onlyIBCModule")
}

// OnlyIBCModule is a paid mutator transaction binding the contract method 0x1649a4f7.
//
// Solidity: function onlyIBCModule() returns()
func (_Ibchost *IbchostSession) OnlyIBCModule() (*types.Transaction, error) {
	return _Ibchost.Contract.OnlyIBCModule(&_Ibchost.TransactOpts)
}

// OnlyIBCModule is a paid mutator transaction binding the contract method 0x1649a4f7.
//
// Solidity: function onlyIBCModule() returns()
func (_Ibchost *IbchostTransactorSession) OnlyIBCModule() (*types.Transaction, error) {
	return _Ibchost.Contract.OnlyIBCModule(&_Ibchost.TransactOpts)
}
