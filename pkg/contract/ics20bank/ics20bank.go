...
// ADMINROLE is a paid mutator transaction binding the contract method 0x75b238fc.
//
// Solidity: function ADMIN_ROLE() returns(bytes32)
func (_Ics20bank *Ics20bankTransactor) ADMINROLE(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Ics20bank.contract.Transact(opts, "ADMIN_ROLE")
}

// ADMINROLE is a paid mutator transaction binding the contract method 0x75b238fc.
//
// Solidity: function ADMIN_ROLE() returns(bytes32)
func (_Ics20bank *Ics20bankSession) ADMINROLE() (*types.Transaction, error) {
	return _Ics20bank.Contract.ADMINROLE(&_Ics20bank.TransactOpts)
}

// ADMINROLE is a paid mutator transaction binding the contract method 0x75b238fc.
//
// Solidity: function ADMIN_ROLE() returns(bytes32)
func (_Ics20bank *Ics20bankTransactorSession) ADMINROLE() (*types.Transaction, error) {
	return _Ics20bank.Contract.ADMINROLE(&_Ics20bank.TransactOpts)
}
...
func (_Ics20bank *Ics20bankTransactor) DEFAULTADMINROLE(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Ics20bank.contract.Transact(opts, "DEFAULT_ADMIN_ROLE")
}

// DEFAULTADMINROLE is a paid mutator transaction binding the contract method 0xa217fddf.
//
// Solidity: function DEFAULT_ADMIN_ROLE() returns(bytes32)
func (_Ics20bank *Ics20bankSession) DEFAULTADMINROLE() (*types.Transaction, error) {
	return _Ics20bank.Contract.DEFAULTADMINROLE(&_Ics20bank.TransactOpts)
}

// DEFAULTADMINROLE is a paid mutator transaction binding the contract method 0xa217fddf.
//
// Solidity: function DEFAULT_ADMIN_ROLE() returns(bytes32)
func (_Ics20bank *Ics20bankTransactorSession) DEFAULTADMINROLE() (*types.Transaction, error) {
	return _Ics20bank.Contract.DEFAULTADMINROLE(&_Ics20bank.TransactOpts)
}

// OPERATORROLE is a paid mutator transaction binding the contract method 0xf5b541a6.
//
// Solidity: function OPERATOR_ROLE() returns(bytes32)
func (_Ics20bank *Ics20bankTransactor) OPERATORROLE(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Ics20bank.contract.Transact(opts, "OPERATOR_ROLE")
}

// OPERATORROLE is a paid mutator transaction binding the contract method 0xf5b541a6.
//
// Solidity: function OPERATOR_ROLE() returns(bytes32)
func (_Ics20bank *Ics20bankSession) OPERATORROLE() (*types.Transaction, error) {
	return _Ics20bank.Contract.OPERATORROLE(&_Ics20bank.TransactOpts)
}

// OPERATORROLE is a paid mutator transaction binding the contract method 0xf5b541a6.
//
// Solidity: function OPERATOR_ROLE() returns(bytes32)
func (_Ics20bank *Ics20bankTransactorSession) OPERATORROLE() (*types.Transaction, error) {
	return _Ics20bank.Contract.OPERATORROLE(&_Ics20bank.TransactOpts)
}

// BalanceOf is a paid mutator transaction binding the contract method 0xb9b092c8.
//
// Solidity: function balanceOf(address account, string id) returns(uint256)
func (_Ics20bank *Ics20bankTransactor) BalanceOf(opts *bind.TransactOpts, account common.Address, id string) (*types.Transaction, error) {
	return _Ics20bank.contract.Transact(opts, "balanceOf", account, id)
}

// BalanceOf is a paid mutator transaction binding the contract method 0xb9b092c8.
//
// Solidity: function balanceOf(address account, string id) returns(uint256)
func (_Ics20bank *Ics20bankSession) BalanceOf(account common.Address, id string) (*types.Transaction, error) {
	return _Ics20bank.Contract.BalanceOf(&_Ics20bank.TransactOpts, account, id)
}

// BalanceOf is a paid mutator transaction binding the contract method 0xb9b092c8.
//
// Solidity: function balanceOf(address account, string id) returns(uint256)
func (_Ics20bank *Ics20bankTransactorSession) BalanceOf(account common.Address, id string) (*types.Transaction, error) {
	return _Ics20bank.Contract.BalanceOf(&_Ics20bank.TransactOpts, account, id)
}
...
func (_Ics20bank *Ics20bankTransactor) GetRoleAdmin(opts *bind.TransactOpts, role [32]byte) (*types.Transaction, error) {
	return _Ics20bank.contract.Transact(opts, "getRoleAdmin", role)
}

// GetRoleAdmin is a paid mutator transaction binding the contract method 0x248a9ca3.
//
// Solidity: function getRoleAdmin(bytes32 role) returns(bytes32)
func (_Ics20bank *Ics20bankSession) GetRoleAdmin(role [32]byte) (*types.Transaction, error) {
	return _Ics20bank.Contract.GetRoleAdmin(&_Ics20bank.TransactOpts, role)
}

// GetRoleAdmin is a paid mutator transaction binding the contract method 0x248a9ca3.
//
// Solidity: function getRoleAdmin(bytes32 role) returns(bytes32)
func (_Ics20bank *Ics20bankTransactorSession) GetRoleAdmin(role [32]byte) (*types.Transaction, error) {
	return _Ics20bank.Contract.GetRoleAdmin(&_Ics20bank.TransactOpts, role)
}
...
func (_Ics20bank *Ics20bankTransactor) HasRole(opts *bind.TransactOpts, role [32]byte, account common.Address) (*types.Transaction, error) {
	return _Ics20bank.contract.Transact(opts, "hasRole", role, account)
}

// HasRole is a paid mutator transaction binding the contract method 0x91d14854.
//
// Solidity: function hasRole(bytes32 role, address account) returns(bool)
func (_Ics20bank *Ics20bankSession) HasRole(role [32]byte, account common.Address) (*types.Transaction, error) {
	return _Ics20bank.Contract.HasRole(&_Ics20bank.TransactOpts, role, account)
}

// HasRole is a paid mutator transaction binding the contract method 0x91d14854.
//
// Solidity: function hasRole(bytes32 role, address account) returns(bool)
func (_Ics20bank *Ics20bankTransactorSession) HasRole(role [32]byte, account common.Address) (*types.Transaction, error) {
	return _Ics20bank.Contract.HasRole(&_Ics20bank.TransactOpts, role, account)
}
...
func (_Ics20bank *Ics20bankTransactor) SupportsInterface(opts *bind.TransactOpts, interfaceId [4]byte) (*types.Transaction, error) {
	return _Ics20bank.contract.Transact(opts, "supportsInterface", interfaceId)
}

// SupportsInterface is a paid mutator transaction binding the contract method 0x01ffc9a7.
//
// Solidity: function supportsInterface(bytes4 interfaceId) returns(bool)
func (_Ics20bank *Ics20bankSession) SupportsInterface(interfaceId [4]byte) (*types.Transaction, error) {
	return _Ics20bank.Contract.SupportsInterface(&_Ics20bank.TransactOpts, interfaceId)
}

// SupportsInterface is a paid mutator transaction binding the contract method 0x01ffc9a7.
//
// Solidity: function supportsInterface(bytes4 interfaceId) returns(bool)
func (_Ics20bank *Ics20bankTransactorSession) SupportsInterface(interfaceId [4]byte) (*types.Transaction, error) {
	return _Ics20bank.Contract.SupportsInterface(&_Ics20bank.TransactOpts, interfaceId)
}
