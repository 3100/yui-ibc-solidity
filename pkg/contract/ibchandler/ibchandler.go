...
// GetHostAddress is a paid mutator transaction binding the contract method 0xeb238c77.
//
// Solidity: function getHostAddress() returns(address)
func (_Ibchandler *IbchandlerTransactor) GetHostAddress(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Ibchandler.contract.Transact(opts, "getHostAddress")
}

// GetHostAddress is a paid mutator transaction binding the contract method 0xeb238c77.
//
// Solidity: function getHostAddress() returns(address)
func (_Ibchandler *IbchandlerSession) GetHostAddress() (*types.Transaction, error) {
	return _Ibchandler.Contract.GetHostAddress(&_Ibchandler.TransactOpts)
}

// GetHostAddress is a paid mutator transaction binding the contract method 0xeb238c77.
//
// Solidity: function getHostAddress() returns(address)
func (_Ibchandler *IbchandlerTransactorSession) GetHostAddress() (*types.Transaction, error) {
	return _Ibchandler.Contract.GetHostAddress(&_Ibchandler.TransactOpts)
}
